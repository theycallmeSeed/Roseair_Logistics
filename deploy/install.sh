...
echo ""
echo "Next steps:"
echo "  1. Clone/push the repository to ${APP_DIR}"
echo "  2. Copy .env.production.example to ${APP_DIR}/.env.production and fill secrets"
echo "  3. Run: cd ${APP_DIR} && npm ci"
echo "  4. Run: cd ${APP_DIR} && npm run build"
echo "  5. Run: cd ${APP_DIR} && sudo nginx -t && sudo systemctl reload nginx"
echo "  6. Run: cd ${APP_DIR} && pm2 start ecosystem.config.js"
