  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Projectos & Casos de Sucesso — Roseair Logistics" },
      {
        ...
        content: "Casos reais: Brisa e Sol, Heavysand, Macsteel, Haiyu Mining e mais.",
      },
...
const projects: {
...
}[] = [
  {
    ...
    image: projectImg,
    short:
      "Importação contínua de materiais de construção para um dos maiores investimentos do sector automóvel e turismo em Moçambique.",
  ...
  },
  {
    ...
    full: "Apoio integrado em operações marítimas FCL para a Mozambique Heavysand, gerindo desembaraço, transporte portuário e documentação aduaneira em ciclos trimestrais.",
  },
  {
    id: "haiyu",
    ...
    full: "Coordenação de transporte rodoviário com parceiros estratégicos para a Haiyu Mining, suportando trânsito SADC e armazenagem alfandegada para equipamento e consumíveis críticos.",
  },
  {
    id: "macsteel",
    ...
    full: "A Roseair gere o desembaraço aduaneiro recorrente da Macsteel Mozambique para produtos siderúrgicos importados, com SLA específicos de prazo e zero não-conformidades documentais.",
  },
  {
    id: "chinahenan",
    ...
    full: "Apoio à China Henan na importação de equipamento industrial e contentores de projecto, com gestão integrada de marítimo, terrestre e desembaraço.",
  },
  {
    id: "watt",
    ...
    full: "Operação aérea com parceiros internacionais para a Watt Trade, garantindo reposição rápida de stock crítico e SLA de 5 dias porta-a-porta.",
  },
];
        ...
        <div className="mx-auto max-w-7xl container-px py-14">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {list.map((p) => (
              <div key={p.id}>
                <Card
                  className="group overflow-hidden border border-border shadow-card hover:shadow-card-hover transition-all cursor-pointer h-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                  onClick={() => setActive(p)}
                  onKeyDown={(e) => {
                ...
                >
                  {/* <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-secondary/80 to-transparent flex items-end p-4">
                      <span className="rounded-full bg-primary text-primary-foreground px-4 py-1.5 text-xs font-semibold opacity-90 group-hover:opacity-100 transition-opacity">
                        Ver Detalhes <ArrowRight className="inline ml-1 h-3.5 w-3.5" />
                      </span>
                    </div>
      ...
      <section className="bg-gradient-cta text-white">
        <div className="mx-auto max-w-4xl container-px py-16 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold">
            Torne-se o Nosso Próximo Caso de Sucesso
          </h2>
          <Button
            asChild
            size="lg"
          ...
          {active && (
            <>
              ...
              <div className="rounded-lg bg-primary/10 border border-primary/30 p-4 text-sm">
                <strong className="text-primary">Resultado: </strong>
                {active.result}
              </div>
            </>
          )}
